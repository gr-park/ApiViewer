...
| ① 차단대상 | `①-⑥ 사용으로 변경` | 차단대상에서 담당자 판단 → 사용 (수동) | 수동 (옵션A: 라벨 그대로) |
...
| 상태 | 의미 | 입력 경로 |
|------|------|----------|
| `①-⑥ 사용으로 변경` | 자동 판정으론 ①-②/①-③ 등 차단대상이지만 담당자 검토 결과 사용중으로 확정 | 일괄변경 / 단건수정 / 엑셀 업로드 |
| `②-⑤ 사용으로 변경` | 자동 판정으론 ②-* 추가검토대상이지만 담당자 검토 결과 사용중으로 확정 | 동일 |
